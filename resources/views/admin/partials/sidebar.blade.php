<aside
  ...
  class="sidebar fixed left-0 top-0 z-9999 flex h-screen w-[290px] flex-col overflow-y-hidden border-r border-gray-200 bg-white px-5 shadow-lg dark:border-gray-800 dark:bg-black dark:shadow-gray-900/50 lg:static lg:translate-x-0"
>
  <!-- SIDEBAR HEADER -->
  <div
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            <a
              ...
              @click="selected = ''"
              class="menu-item group"
              :class="page === 'calendar' ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg
              :class="page === 'calendar' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
          ...
          <li>
            ...
            <div
              class="overflow-hidden transform translate"
              :class="(selected === 'Forms') || (page === 'formElements' || page === 'formLayout' || page === 'proFormElements' || page === 'proFormLayout') ? 'block' :'hidden'"
            >
              <ul
                :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9"
              >
                <li>
                  <a
                    href="{{ route('admin.forms.elements') }}"
                    class="menu-dropdown-item group"
          ...
          <li>
            ...
            <div
              class="overflow-hidden transform translate"
              :class="(selected === 'Tables') || (page === 'basicTables' || page === 'dataTables') ? 'block' :'hidden'"
            >
              <ul
                :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9"
          ...
          <li>
            ...
            <div
              class="overflow-hidden transform translate"
              :class="(selected === 'Pages') || (page === 'blank' || page === 'page404') ? 'block' :'hidden'"
            >
              <ul
                :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9"
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            ...
            <div
              class="overflow-hidden transform translate"
              :class="(selected === 'Charts') || (page === 'lineChart' || page === 'barChart') ? 'block' :'hidden'"
            >
              <ul
                :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9"
          ...
          <li>
            ...
            <div
              class="overflow-hidden transform translate"
              :class="(selected === 'UIElements') || (page === 'alerts' || page === 'avatars' || page === 'badge' || page === 'buttons' || page === 'images' || page === 'videos') ? 'block' :'hidden'"
            >
              <ul
                :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9"
