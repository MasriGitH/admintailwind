...
<div class="min-h-screen flex">
  ...
  <div class="hidden xl:flex xl:w-1/2 flex-col justify-between bg-brand-950 p-10 dark:bg-white/5 relative overflow-hidden">
    ...
    <div class="relative z-10">
      <h2 class="text-4xl font-bold text-white mb-4 leading-tight">
        Welcome back to<br />Admin Panel
      </h2>
      <p class="text-gray-400 text-lg">
        Sign in to manage your dashboard, track orders, and monitor your business.
      </p>
    </div>
  ...
  <div class="flex flex-1 flex-col items-center justify-center px-6 py-12 bg-white dark:bg-gray-900">
    <div class="w-full max-w-md">
      ...
      <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white/90 mb-2">Sign In</h1>
        <p class="text-gray-500 dark:text-gray-400 text-sm">Enter your email and password to access your account.</p>
      </div>
      ...
      <form action="{{ route('login') }}" method="POST" class="space-y-5">
        ...
        <div class="flex items-center gap-2">
          ...
          />
          <label for="remember" class="text-sm text-gray-600 dark:text-gray-400">Keep me signed in</label>
        </div>
        ...
        <p class="text-center text-sm text-gray-500 dark:text-gray-400">
          ...
          <a href="{{ route('register') }}" class="font-medium text-brand-500 hover:text-brand-600 dark:text-brand-400">
            Create Account
          </a>
        </p>
      </form>
